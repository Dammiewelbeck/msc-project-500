<?php
    ...
    $logAccount = mysqli_query($database, "SELECT id, username, role, image FROM users WHERE id = '".$_SESSION['id']."'");
    $account = mysqli_fetch_assoc($logAccount);
              ...
              <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                ...
                <li class="nav-item dropdown custom-drop">
                  <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="../assets/images/users/<?= $account['image']; ?>" alt="User-Profile" class="theme-color-default-img img-fluid avatar avatar-50 avatar-rounded">
                    <div class="caption ms-3 d-none d-md-block ">
                        <h6 class="mb-0 caption-title"><?= htmlspecialchars($account['username']); ?></h6>
                        <p class="mb-0 caption-sub-title"><?= $account['role']; ?></p>
                    </div>
                  </a>
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="<?php echo dirname($_SERVER['PHP_SELF']) . '/../administration/profile.php';?>">Profile</a></li>
